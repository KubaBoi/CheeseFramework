...
class ResMan:
    ...
    @staticmethod
    def src():
        return os.path.join(f"{ResMan.root()}", "src")

    # other resources of project
    @staticmethod
    def resources():
        return os.path.join(f"{ResMan.root()}", "resources")
    ...
    @staticmethod
    def web():
        return os.path.join(f"{ResMan.root()}", "web")
    ...
    @staticmethod
    def metadata():
        return os.path.join(f"{ResMan.src()}", ".metadata")
