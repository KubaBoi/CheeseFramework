...
with open(readmeFile, "w") as f:
    f.write(
        f"# Cheese Framework\n\n" +
        f"[![Release v({releaseDate})](https://github.com/KubaBoi/CheeseFramework/actions/workflows/realeaseDate.yml/badge.svg)](https://github.com/KubaBoi/CheeseFramework/actions/workflows/realeaseDate.yml)\n\n" +
